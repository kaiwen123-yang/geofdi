...
two-step example in the companion note
\texttt{theory/counterexamples/product\_kernel\_gap.pdf}). Definition
...
order $\Tc\,\eps{\bullet}$, and the two-step example of the companion note
\texttt{theory/counterexamples/product\_kernel\_gap.pdf} comes arbitrarily
close to $\Tc\,\eps{ctrl}$. Contraction does not change this: if the one-step
