...
ordering and every reflection sign in Table~\ref{tab:joint-signs-hw} were fixed on
...
\centering
\footnotesize
\begin{tabular}{@{}p{2.4cm}p{3.3cm}p{2.3cm}cc@{}}
\toprule
...
\bottomrule
\end{tabular}
\caption{Per-channel reflection signs under $\gs$ \emph{as verified on hardware} (the platform-specific instantiation of the generic Table~\ref{tab:joint-signs}). M1:
